...
const proyecto = getProyecto("/proyecto-santacatalina");
const departamentos = getDepartamentos("santacatalina");

export const Route = createFileRoute("/proyecto-santacatalina")({
  head: () => ({
    meta: [
      {
